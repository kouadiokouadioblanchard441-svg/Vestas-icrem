...
export const CONTENT_GROUPS: ContentGroup[] = [
  {
    ...
    fields: [
      ...
      { key: "content_home_popupLine1", label: "Ligne 1", defaultValue: "Power Add Inc. a été fondée en 1996 comme unité indépendante du groupe Tekman.", multiline: true },
      { key: "content_home_popupLine2", label: "Ligne 2", defaultValue: "Power Add développe des alimentations électriques, des convertisseurs et des conceptions personnalisées.", multiline: true },
      { key: "content_home_popupLine3", label: "Ligne 3", defaultValue: "Les solutions Power Add couvrent les adaptateurs, alimentations open frame, alimentations en U, modèles box et convertisseurs DC/DC.", multiline: true },
      { key: "content_home_popupLine4", label: "Ligne 4", defaultValue: "La recherche et la fabrication pilote sont réalisées à Taïwan ; la production de masse est réalisée à Taïwan et en Chine.", multiline: true },
      { key: "content_home_popupLine5", label: "Ligne 5", defaultValue: "Power Add indique être certifiée ISO 9001 et ISO 14001 et met en avant l’amélioration continue.", multiline: true },
    ],
  },
  {
    id: "rules",
    ...
    fields: [
      ...
      { key: "content_rules_section5Body", label: "Contenu section 5", defaultValue: "Chaque nouveau membre reçoit 500 USDT de bonus à l'inscription.", multiline: true },
    ],
  },
  {
    id: "team",
