...
export const CONTENT_GROUPS: ContentGroup[] = [
  {
    ...
    fields: [
      ...
      { key: "content_home_popupLine1", label: "Ligne 1", defaultValue: "Prime d'inscription : 500 USDT.", multiline: true },
      { key: "content_home_popupLine2", label: "Ligne 2", defaultValue: "Récompense de connexion quotidienne : 50 USDT.", multiline: true },
