...
- [SpolarPV WestPay webhook secret](spolarpv-westpay-webhook.md) — secret now DB-backed (admin-panel editable) since production runs on external Plesk; dev DB = shared/production Supabase.
