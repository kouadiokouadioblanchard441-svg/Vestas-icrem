                ...
                <div className="flex items-start justify-between mb-3">
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {(user as any).isBanker && <Badge className="text-xs bg-green-600">Bankier</Badge>}
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {!selectedUser.isAdmin && !selectedUser.isSuperAdmin && (
                    <Button
                      ...
                      className={(selectedUser as any).isBanker ? "bg-green-600 hover:bg-green-700 col-span-2" : "col-span-2"}
