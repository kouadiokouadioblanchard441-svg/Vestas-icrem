    ...
    <div className="flex flex-col min-h-screen" style={{ background: "#87CEEB" }}>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-[#F59E0B]">Qui sommes-nous ?</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-[#F59E0B]">🏭 Fabrication et Installation</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-[#F59E0B]">Notre héritage</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-[#F59E0B]">Sécurité et Fiabilité</h2>
          <p className="text-gray-600 leading-relaxed">
