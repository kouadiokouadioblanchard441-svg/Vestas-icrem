...
export interface VipLevelConfig {
  ...
  description: string;
  advantages: string;
  /** Conditions requises (null = aucune condition supplémentaire) */
...
export const VIP_BADGE_STYLE: Record<number, { bg: string; text: string; border: string }> = {
  ...
  1: { bg: "linear-gradient(90deg,#6b7c2e,#4a5e22)", text: "#fff", border: "transparent" },
...
/** Merge les valeurs admin dans les configs par défaut */
