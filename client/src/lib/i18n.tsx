...
const T: Record<Lang, Translations> = {
  zh: {
    ...
    teamActiveProduct: "有效产品",
    teamDeposited: "已充值",
    teamTotalInvested: "总投资",
    teamPurchasedProducts: "已购产品",
    teamActiveStatus: "活跃",
    teamEndedStatus: "已结束",
    teamNoProductPurchased: "未购产品",
    teamLevel: "级别",
    teamMember: "会员",
    teamTotalTeamInvested: "团队总投资",
    teamLevelShort: "Lv.",
    teamNoLevel1: "暂无一级成员",
    teamNoLevel2: "暂无二级成员",
    teamNoLevel3: "暂无三级成员",
    ...
    adminSearchByPhoneOrName: "按电话或姓名搜索...",
    adminSearchDeposit: "搜索充值...",
    adminChannelName: "渠道名称",
    adminRedirectUrl: "重定向URL",
    adminApiPayment: "自动API支付",
    adminNoChannel: "暂无支付渠道",
    adminEditChannel: "编辑渠道",
    adminNewChannel: "新增渠道",
    adminAutoMode: "自动模式",
    adminManualMode: "手动模式",
    adminManualModeActivated: "✋ 手动模式已启用",
    adminAutoModeActivated: "⚡ 自动模式已启用",
    adminManualModeLabel: "手动模式",
    adminAutoModeLabel: "自动模式",
    adminManualModeDesc: "每次提现需要手动审核",
    adminAutoModeDesc: "NOWPayments自动处理 + 2FA验证码",
    adminNoWithdrawals: "暂无提现记录",
    adminManualPayment: "手动支付",
    adminUserActive: "活跃",
    adminUserDeposited: "已充值",
    adminUserTeamTitle: "团队",
    adminUserRegisteredOn: "注册日期",
    adminUserNotProvided: "未填写",
    adminUserTransactionPwd: "交易密码",
    adminUserInvitedBy: "邀请人",
    adminUserReferralCode: "推荐码",
    ...
    adminPinCode: "PIN码",
    adminTaskName: "任务名称",
    adminTaskNamePlaceholder: "输入任务名称...",
    adminTaskDescriptionLabel: "描述",
    adminTaskDescriptionPlaceholder: "输入任务描述...",
    adminTaskRequiredInvites: "所需邀请数",
    adminTaskReward: "奖励",
    adminTaskSortOrder: "排序",
    adminTaskNew: "新建任务",
    adminTaskEdit: "编辑任务",
    adminTaskActive: "活跃",
    adminTaskInactive: "未激活",
    adminTaskCreated: "任务已创建",
    adminTaskUpdated: "任务已更新",
    adminTaskDeleted: "任务已删除",
    adminTaskDeleteWarning: "此操作无法撤销。",
    adminTaskDelete: "删除",
    adminNoTasks: "暂无任务",
    adminTaskCenterTitle: "任务中心",
    adminTaskCenterDesc: "管理用户任务和奖励",
    adminChannelCreated: "渠道已创建！",
    adminChannelUpdated: "渠道已更新！",
    adminChannelDeleted: "渠道已删除！",
    adminCountriesTitle: "国家管理",
    adminAddCountry: "添加国家",
    adminEditCountry: "编辑国家",
    adminDeleteCountryTitle: "删除此国家？",
    adminCountryIrreversible: "此操作无法撤销。",
    adminCountryActiveLabel: "国家已激活",
    adminCountryCodeLabel: "国家代码（如：CM）",
    adminCountryCurrencyLabel: "货币（如：USDT）",
    adminCountryNameLabel: "国家名称",
    adminCountryPhoneLabel: "电话区号（不含+）",
    adminCountryOperatorsLabel: "运营商（逗号分隔）",
    adminCountryOperatorsHint: "示例：Airtel Money, Moov Money",
    adminCountryPhoneDisplay: "区号: +",
    adminCountryUpdated: "国家已更新！",
    adminCountryAdded: "国家已添加！",
    adminCountryDeleted: "国家已删除！",
    adminNoCountries: "暂无国家配置",
    adminCompanyDesc: "添加公司信息、投资计划和图片。",
    adminCompanyAdd: "添加",
    adminCompanyEditBlock: "编辑块",
    adminCompanyNewBlock: "新建块",
    adminCompanyBlockTitle: "标题",
    adminCompanyBlockTitlePlaceholder: "例：我们的公司",
    adminCompanyBlockBody: "内容",
    adminCompanyBlockBodyPlaceholder: "介绍公司...",
    adminCompanyBlockImage: "图片",
    adminCompanyBlockImageOptional: "（可选）",
    adminCompanyBlockPreview: "预览",
    adminCompanyBlockImageRemove: "删除图片",
    adminCompanyBlockImageChange: "更换图片",
    adminCompanyBlockImageChoose: "选择图片",
    adminCompanyBlockImageUrlPlaceholder: "或粘贴 https:// URL...",
    adminCompanyBlockOrder: "显示顺序",
    adminCompanyBlockVisible: "可见",
    adminCompanyBlockHidden: "隐藏",
    adminCompanyBlockNoText: "无内容",
    adminCompanyEmpty: "暂无内容，请添加第一个块。",
    adminCompanyBlockModified: "块已修改",
    adminCompanyBlockAdded: "块已添加",
    adminCompanyBlockDeleted: "块已删除",
    adminCompanyBlockImageTooBig: "图片过大",
    adminCompanyBlockImageMaxSize: "最大 2 MB",
    adminCompanyBlockDeletePrefix: "删除 «",
    adminCompanyBlockSave: "保存",
    adminContentDesc: "在此修改应用中显示的所有文本、消息和弹窗。保存后立即生效。",
    adminContentSaved: "文本已保存！",
    adminContentSave: "保存文本",
    adminWheelTitle: "转盘配置",
    adminWheelDesc: "8个奖品始终显示在转盘上。禁用的格子仍会显示但不会被抽中。",
    adminWheelSection: "区块",
    adminWheelCanWin: "可中奖",
    adminWheelCannotWin: "不可中奖",
    adminWheelDisplayName: "显示名称",
    adminWheelDisplayNamePlaceholder: "例：小奖励",
    adminWheelAmount: "金额（USDT）",
    adminWheelColor: "颜色",
    adminWheelWarning: "保存前请至少启用一个可中奖区块。",
    adminWheelSave: "保存转盘",
    adminWheelSaved: "转盘配置已保存！",
    adminWheelSaveError: "无法保存转盘配置",
    adminWithdrawalAutoBtn: "自动",
    ...
    adminWithdrawal2FAProcessing: "提现正在处理中。",
    adminWithdrawalPayoutId: "Payout ID:",
    adminWithdrawalNowPaymentsId: "Payout NOWPayments：",
    adminWithdrawalNowPaymentsValidated: "NOWPayments支付已验证",
    adminWithdrawalNowPaymentsValidatedDesc: "提现正在处理中。",
    adminWithdrawalNowPaymentsFailed: "NOWPayments验证失败",
    adminWithdrawalServerError: "服务器错误",
    adminWithdrawalAt: " ",
    adminSettingsSaved: "设置已保存！",
    adminSettingsGoOnline: "恢复网站上线",
    adminSettingsGoOffline: "关闭网站",
    adminSettingsMaintenanceMode: "维护模式",
    adminSettingsMaintenanceActive: "维护中",
    adminSettingsRunning: "运行中",
    approve: "批准",
    reject: "拒绝",
    rejectAndBan: "拒绝并封禁",
    amount: "金额",
    ...
    payerNumber: "付款人号码",
    date: "日期",
    recipientNumber: "收款人号码",
    reference: "参考",
    paymentMessageReceived: "收到付款消息",
    screenshot: "截图",
    grossAmount: "总金额",
    netAmount: "净金额",
    fees: "手续费",
    method: "方式",
    bep20Address: "BEP-20地址",
    dateTime: "日期/时间",
