  ...
  const requiredCountries = [
    {
      ...
      currency: "FCFA",
      phonePrefix: "225",
      operators: JSON.stringify(["Orange CI", "MTN CI", "Wave CI", "Moov Africa CI"]),
      isActive: true,
    ...
    },
    {
      ...
      currency: "FCFA",
      phonePrefix: "226",
      operators: JSON.stringify(["Orange Burkina", "Moov Africa Burkina", "Telecel Burkina"]),
      isActive: true,
      autoPaymentEnabled: true,
    },
    {
      ...
      currency: "FCFA",
      phonePrefix: "223",
      operators: JSON.stringify(["Orange Mali", "Moov Africa Mali", "Telecel Mali"]),
      isActive: true,
      autoPaymentEnabled: true,
    },
    {
      ...
      currency: "FCFA",
      phonePrefix: "229",
      operators: JSON.stringify(["MTN Bénin", "Moov Africa Bénin"]),
      isActive: true,
      autoPaymentEnabled: true,
    },
  ];
